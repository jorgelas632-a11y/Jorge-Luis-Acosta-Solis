document.addEventListener('DOMContentLoaded', () => {
    ...
    const links = [
        ...
        { name: "Contacto por Email", url: "https://mail.google.com/mail/u/0/#inbox?compose=NZVHFwWHbvgkKnwRxGvXPbMbWtjgGHBLNtGkgdqJRbhHnnjdgRqjvpKHtfgffZgglbBBcL", icon: "bi bi-envelope" }
    ];
